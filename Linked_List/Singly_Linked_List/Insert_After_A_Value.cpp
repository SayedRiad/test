...
public:
    ...
    void insert_after_a_value(int val, int value){
        node *a = head;
        while(a != NULL){
            if(a -> data == val){
                sz++;
...
int main(){
    ...
    l.traverse();
    l.insert_after_a_value(10,100);
    l.insert_after_a_value(20,23);
    l.insert_after_a_value(100,230);
    l.insert_after_a_value(300,1000);
    l.traverse();
    cout << l.getSize() <<endl;
    l.printReverse();
